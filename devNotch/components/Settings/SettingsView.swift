...
struct GeneralSettings: View {
    ...
    @EnvironmentObject var vm: DevViewModel
        ...
        VStack {
            Form {
                ...
                Section {
                    ...
                    Text("DevNotch is an independent fork that builds on the original Boring Notch project.")
                        .foregroundStyle(.secondary)
                }
                ...
                HStack(spacing: 30) {
                    Spacer(minLength: 0)
                    Button {
                        if let url = URL(string: "https://github.com/NoamFav/DevNotch") {
                            NSWorkspace.shared.open(url)
                        }
                    } label: {
                        VStack(spacing: 5) {
