...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.noamfav.devnotch.DevNotchXPCHelper"
    
    private var remoteService: RemoteXPCService<DevNotchXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<DevNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<DevNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: DevNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<DevNotchXPCHelperProtocol>? {
        remoteService
    }
